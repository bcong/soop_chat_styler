  ...
  (function() {
    ...
    class MainStore {
      constructor() {
        ...
        __publicField(this, "_liveDetail", null);
        ...
        __publicField(this, "setChannelId", (channelId) => {
          this._channelId = channelId;
        });
        __publicField(this, "setLiveDetail", (liveDetail) => {
    ...
    __decorateClass([
      observable
    ], MainStore.prototype, "_channelId", 2);
    __decorateClass([
      observable
    ], MainStore.prototype, "_liveDetail", 2);
    __decorateClass([
      observable
    ...
    __decorateClass([
      action
    ], MainStore.prototype, "setChannelId", 2);
    __decorateClass([
      action
    ], MainStore.prototype, "setLiveDetail", 2);
    __decorateClass([
      action
    ...
    __decorateClass([
      computed
    ], MainStore.prototype, "channelId", 1);
    __decorateClass([
      computed
    ], MainStore.prototype, "liveDetail", 1);
    __decorateClass([
      computed
    ...
    const Chat = observer(() => {
      ...
      const chat_style = mainStore.setting.get("chat_style");
      const pathUpdate = reactExports.useRef(null);
      const pingIntervalId = reactExports.useRef(null);
      const [reconnectAttempts, setReconnectAttempts] = reactExports.useState(0);
      const reconnectDelay = 6e4;
      ...
      const calculateByteSize = (input) => {
        const encoder = new TextEncoder();
        const encoded = encoder.encode(input);
        return encoded.length + 6;
      };
      const makeChatUrl = (liveDetail) => {
      ...
      const fetchLiveDetails = async (newChannelId) => {
      ...
      const connect = async (newChannelId) => {
        ...
        ws.onopen = () => {
          ...
          const CONNECT_PACKET = `${"\x1B	"}${"0001"}00000600${"\f".repeat(3)}16${"\f"}`;
          ws == null ? void 0 : ws.send(CONNECT_PACKET);
      ...
      const parseAdBalloonDonation = (packet) => {
        const parts = packet.split(
          "\f"
          /* SEPARATOR */
        );
      ...
      const parseVideoDonation = (packet) => {
        const parts = packet.split(
          "\f"
          /* SEPARATOR */
        );
      ...
      const parseTextDonation = (packet) => {
        const parts = packet.split(
          "\f"
          /* SEPARATOR */
        );
      ...
      const parseNotification = (packet) => {
        const parts = packet.split(
          "\f"
          /* SEPARATOR */
        );
      ...
      const startPingInterval = () => {
        ...
        pingIntervalId.current = setInterval(() => {
          var _a2;
          if (((_a2 = mainStore.currentChat) == null ? void 0 : _a2.readyState) === WebSocket.OPEN) {
            const PING_PACKET = `${"\x1B	"}${"0000"}0000000100${"\f"}`;
      ...
      const disconnect = async () => {
        if (mainStore.currentChat) {
          ...
          await new Promise((resolve) => {
            var _a2;
            return resolve((_a2 = mainStore.currentChat) == null ? void 0 : _a2.close());
          });
      ...
      const handleMessage = async (data) => {
        ...
        switch (messageType) {
          case "0001": {
            const JOIN_PACKET = `${"\x1B	"}${"0002"}${calculateByteSize(mainStore.liveDetail.CHANNEL.CHATNO).toString().padStart(6, "0")}00${"\f"}${mainStore.liveDetail.CHANNEL.CHATNO}${"\f".repeat(5)}`;
            (_a2 = mainStore.currentChat) == null ? void 0 : _a2.send(JOIN_PACKET);
