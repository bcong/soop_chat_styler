  ...
  (function() {
    ...
    const SettingMenuComponent = ({
      ...
      reactExports.useEffect(() => {
        ...
        listItemElement.className = styles$2.SettingMenu;
    ...
    const Setting = "_Setting_1vdbf_1";
    const View = "_View_1vdbf_17";
    const Header = "_Header_1vdbf_20";
    const Title = "_Title_1vdbf_31";
    const Menus = "_Menus_1vdbf_34";
    const Menu = "_Menu_1vdbf_34";
    const Content = "_Content_1vdbf_51";
    const Name = "_Name_1vdbf_61";
    const Value = "_Value_1vdbf_68";
    const styles$1 = {
      Setting,
      View,
      Header,
    ...
    const ToggleButton = ({
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.ToggleButton, onClick: handleToggle, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes(styles.Circle, enable ? styles.Enable : false) }) });
    };
    const SettingComponent = ({
      ...
      return ReactDOM.createPortal(
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          {
            ref: settingRef,
            className: classes(styles$1.Setting, isSetting ? styles$1.View : false),
            style: { position: "absolute" },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.Header, onMouseDown: handleMouseDown, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$1.Title, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "채팅 스타일러sㄴ" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: styles$1.Menus,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$1.Content, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$1.Menus, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.Menu, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$1.Name, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "스타일러 사용" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$1.Value, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleButton, { enable: GM_getValue("enable", false), setEnable: (value) => GM_setValue("enable", value) }) })
              ] }) }) })
            ]
          }
        ),
    ...
    const App = () => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(SettingComponent, { isSetting, toggleSetting })
      ] });
    };
    log("SOOP 채팅 스타일러 - 비콩");
    async function main() {
