...
(function() {
  ...
  const SettingMenuComponent = ({
    ...
    reactExports.useEffect(() => {
      ...
      listItemElement.className = styles$1.SettingMenu;
  ...
  const Setting = "_Setting_77pon_1";
  const View = "_View_77pon_16";
  const Header = "_Header_77pon_19";
  const Title = "_Title_77pon_30";
  const Menus = "_Menus_77pon_33";
  const Menu = "_Menu_77pon_33";
  const styles = {
    Setting,
    View,
    Header,
